...
\begin{tikzpicture}[remember picture,overlay]
    % Khung viền ngoài
    \draw[line width=3pt] 
        ([xshift=1.5cm,yshift=-2cm]current page.north west) rectangle 
        ([xshift=-1.5cm,yshift=2cm]current page.south east);
    
    % Khung viền trong (trang trí)
    \draw[line width=1pt] 
        ([xshift=2cm,yshift=-2.5cm]current page.north west) rectangle 
...
\begin{center}
    \vspace*{1cm}
    {\fontsize{13pt}{16pt}\selectfont\bfseries ĐẠI HỌC QUỐC GIA HÀ NỘI} \\
    \vspace{5pt}
    {\fontsize{15pt}{18pt}\selectfont\bfseries TRƯỜNG ĐẠI HỌC CÔNG NGHỆ} \\
    \vspace{10pt}
    \center\includegraphics[width=3cm]{images/uet.png}
...
% --- Tiêu đề tài liệu ---
\begin{center}
    {\fontsize{16pt}{20pt}\selectfont\bfseries BÁO CÁO ĐỒ ÁN MÔN HỌC} \\ 
    \vspace{10pt}
    {\fontsize{20pt}{24pt}\selectfont\bfseries AN TOÀN VÀ AN NINH MẠNG} \\
\end{center}
...
\begin{center}
    ...
    \begin{minipage}{0.8\textwidth}
        ...
        {\fontsize{13pt}{16pt}\selectfont\bfseries Lớp học phần: INT3307E 1} \\
        {\fontsize{13pt}{16pt}\selectfont\bfseries Giảng viên: TS. Nguyễn Đại Thọ} \\
        \vspace{25pt}
        {\fontsize{13pt}{16pt}\selectfont\bfseries Sinh viên thực hiện:}

        \vspace{5pt}
        \begin{tabular}{@{}l @{\hspace{1.5cm}} l}
            \bfseries Họ và tên          & \bfseries MSSV \\
            \hline
            \bfseries Nguyễn Tường Hùng        & \bfseries 23020078 \\
        \end{tabular}
    \end{minipage}
\end{center}
...
\begin{center}
    {\fontsize{13pt}{16pt}\selectfont\bfseries Hà Nội, ngày 24 tháng 12 năm 2025}
\end{center}
\vspace*{1cm}
